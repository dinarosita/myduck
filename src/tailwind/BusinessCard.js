    ...
    <Box h3 title="Business Card">
      <SnapFlex>
        <div className=" mx-auto max-w-sm space-y-2 rounded-xl bg-white py-8 px-8 shadow-lg sm:flex sm:items-center sm:space-x-6 sm:space-y-0 sm:py-4">
          <img
            className="mx-auto block h-24 rounded-full bg-amber-100 sm:mx-0 sm:shrink-0"
            src={logo}
            alt="Woman's Face"
          />
          <div className="space-y-2 text-center sm:text-left">
            <div className="space-y-0.5">
              ...
              <p className="font-medium text-amber-600">Product Engineer</p>
            </div>
            <button className="rounded-full border border-amber-200 px-4 py-1 text-sm font-semibold text-amber-600 hover:border-transparent hover:bg-amber-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-amber-600 focus:ring-offset-2">
              Message
            </button>
          </div>
        </div>
