...
const ChatIndexContextCopy = createContext({
  isPageLoading: true,
  isNewUser: false,
  setIsNewUser: () => {},
  chatList: [],
...
export function ChatIndexContextProviderCopy(props) {
  ...
  return (
    <ChatIndexContextCopy.Provider value={context}>
      {props.children}
    </ChatIndexContextCopy.Provider>
  );
}

export default ChatIndexContextCopy;
