      ...
      <div className="my-2 space-y-2">
        <Def title="About" indent div>
          <p className="mb-1">
            ...
            <span className="font-bold text-gold-m">&lt;p&gt;</span> element.
          </p>
        ...
        <Def title="Class btn" indent>
          <Def title="class btn" inline>
            ...
            wrapper is using this as the basic styling. In MyDuck, Link element
            is styled just like a button using this class.
          </Def>
        </Def>
        ...
        <Def title="Styling example: Blue button" div indent>
          <div className="mt-1 space-y-1">
            ...
            <p className="my-1">
              addStyle="text-blue-500 border-blue-500 border-2 hover:bg-blue-500
              hover:text-white"
            </p>
          </div>
        </Def>
        <Def title="Styling example: Right end button" div indent>
          {" "}
          <div className="flex items-center border border-gold-ml p-1">
            <div className="mt-1">
